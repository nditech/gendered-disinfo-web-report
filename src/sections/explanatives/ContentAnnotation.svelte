...
<div style="display: none;">
    <img id="post-facebook" alt="facebook" src="{URL_PREFIX}/assets/imgs/facebook.png">
    <img id="post-twitter" alt="twitter" src="{URL_PREFIX}/assets/imgs/twitter.png">
    <img id="post-telegram" alt="telegram" src="{URL_PREFIX}/assets/imgs/telegram.png">
    <img id="post-youtube" alt="youtube" src="{URL_PREFIX}/assets/imgs/youtube.png">
    <img id="checkmark" alt="checkmark" src="{URL_PREFIX}/assets/imgs/checkmark.png">
    <img id="annotator" alt="annotator" src="{URL_PREFIX}/assets/explanatives/annotator.png">
</div>
