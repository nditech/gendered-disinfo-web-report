...
export class Renderer {
    ...
    are_there_nodes_outside_canvas () {
        for (let i = 0; i < this.graph.nodes.length; i++) {
            ...
            if (is_circle_outside_of_canvas(cx, cy, radius, canvas_width, canvas_height)) {
                return true
            }
        }
        return false
    ...
    map_nodes () {
        ...
        this.graph.nodes.forEach((node, i) => {
            ...
            for (let j = 0; j < 10; j++) {
                ...
                const dist_from_origin = distance_between_2_points(cx, cy, canvas_width / 2.0, canvas_height / 2.0)
